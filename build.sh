...
# TimeVoting Plugin Build and Deploy Script
...
readonly PLUGIN_NAME="TimeVoting"
readonly PLUGIN_ARTIFACT_ID="TimeVoting"

# GitHub configuration
readonly GITHUB_REPO="Staticpast/TimeVoting"
...
Build and deploy the TimeVoting plugin with intelligent change detection.
...
main() {
    ...
    log_info "Starting TimeVoting plugin build and deployment..."
